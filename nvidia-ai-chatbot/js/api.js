...
/**
 * Sends a message with conversation history to the NVIDIA AI API
 * @param {Array} messages - Array of message objects with role and content
 * @param {string} model - The AI model to use
 * @param {Object} params - Additional parameters for the API
 * @returns {Promise<string>} - The AI's response
 */
async function sendMessageWithHistory(messages, model = API_CONFIG.default_model, params = {}) {
  const headers = {
    "Authorization": `Bearer ${API_CONFIG.api_key}`,
    "Content-Type": "application/json",
    "Accept": params.stream ? "text/event-stream" : "application/json"
...
export { sendMessageToAI, sendMessageWithHistory, getAvailableModels, API_CONFIG };